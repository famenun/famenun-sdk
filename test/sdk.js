        ...
        const init = (debug) => {
            ...
            if (window.__famenun_api__ === undefined) {
                ...
                window.__famenun_api__ = {
                    ...
                    clubsHandler: new CircleHandler_1.CircleHandler(requestHandler),
                    paymentsHandler: new PaymentHandler_1.PaymentHandler(requestHandler),
                    broadcastHandler: new PublishHandler_1.PublishHandler(requestHandler),
                    chatroomsHandler: new ChatroomHandler_1.ChatroomHandler(requestHandler),
                    ...
                    linksHandler: new LinkHandler_1.LinkHandler(requestHandler),
                    notificationsHandler: new NotificationHandler_1.NotificationHandler(requestHandler),

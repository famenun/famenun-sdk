...
describe("SDK", () => {
    it("initailse SDk", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield ((_g = api.broadcastHandler) === null || _g === void 0 ? void 0 : _g.broadcast(["file://some/file/path"]));
        ...
        try {
            yield ((_j = api.appGalaxyHandler) === null || _j === void 0 ? void 0 : _j.openApp("test_app"));
        ...
        try {
            const link = yield ((_m = api.linksHandler) === null || _m === void 0 ? void 0 : _m.createDeepLink("./index.html?user=user_uid"));

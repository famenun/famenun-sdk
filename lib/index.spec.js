...
describe("SDK", () => {
    it("initailse SDk", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield ((_c = api.paymentHandler) === null || _c === void 0 ? void 0 : _c.makePayment({
                id: "txn_id",
        ...
        try {
            yield ((_f = api.toastHandler) === null || _f === void 0 ? void 0 : _f.showToast("This is a toast"));
        ...
        try {
            yield ((_g = api.databaseHandler) === null || _g === void 0 ? void 0 : _g.insertData({
                table: "feeds",
                id: "first_entry",
        ...
        try {
            const data = yield ((_h = api.databaseHandler) === null || _h === void 0 ? void 0 : _h.getData({
                table: "feeds"
            }));
            console.log(data);
        }
